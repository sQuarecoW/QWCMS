...
extension CMSModule where Self: CMSSettingsModule {
    ...
    func getSettings(on req: Request) throws -> Future<[String: String]> {
    ...
    func saveSettings(on req: Request, postData: SettingsPostData) throws -> Future<[Setting]> {
        var settings = [Future<Setting>]()
